...
RSpec.describe User do
  ...
  describe "instance methods" do
    ...
    it "sorts reviews based on when they were created" do
      ...
      book_2 = Book.create!(title: "Title Two", pages: 200, year_pub: 1902, cover_img: "https://media.wired.com/photos/5be4cd03db23f3775e466767/master/pass/books-521812297.jpg")
      book_3 = Book.create!(title: "Title Three", pages: 300, year_pub: 1903, cover_img: "https://media.wired.com/photos/5be4cd03db23f3775e466767/master/pass/books-521812297.jpg")
      ...
      review_1 = book_1.reviews.create!(title: "Review One", rating: 1, body: "stuff 1", user: user_1)
      review_2 = book_2.reviews.create!(title: "Review Two", rating: 3, body: "stuff 3", user: user_1)
      review_3 = book_3.reviews.create!(title: "Review Three", rating: 5, body: "stuff 5", user: user_1)

      expect(user_1.sort_reviews_newest).to eq([review_3, review_2, review_1])
    end
    ...
    it "sorts reviews based on when they were created" do
      ...
      expect(user_1.sort_reviews_oldest).to eq([review_1, review_2, review_3])
    end
  ...
  before :each do
    ...
    @review_1 = @book_1.reviews.create!(title: "Review 1", rating: 1, body: "stuff 1", user: @user_1, created_at: 1 )
    ...
    @review_3 = @book_2.reviews.create!(title: "Review 3", rating: 3, body: "stuff 3", user: @user_1, created_at: 2 )
    @review_4 = @book_2.reviews.create!(title: "Review 4", rating: 3, body: "stuff 4", user: @user_2 )

    @review_5 = @book_3.reviews.create!(title: "Review 5", rating: 5, body: "stuff 5", user: @user_1, created_at: 3 )
